...
reward_net = ReparameterizedRewardNetwork(2, 0.0005, None, env.action_space.n, 'reward_net')
reward_net.restore('reparam_runs/sokoban_test/weights', 'reward_net.ckpt')
